...
CREATE TABLE IF NOT EXISTS public.admin_users (
    ...
    role VARCHAR(50) NOT NULL DEFAULT 'STAFF', -- 'SUPER_ADMIN', 'SUPER_USER', 'KETUA_DKM', 'PJ_MEDIA', 'PJ_LOGISTIK', 'PJ_SANTRI', 'PJ_MUSAFIR', 'PJ_IBADAH', 'PJ_KEUANGAN', 'PJ_KEAMANAN', 'PJ_KEBERSIHAN'
